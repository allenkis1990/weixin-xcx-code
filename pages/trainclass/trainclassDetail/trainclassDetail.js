  ...
  */
    requestAssessmentRequirements() {
      ...
      app.requestData(app.config.assessmentRequirements, param, "POST").then(data => {
        ...
        //数据赋值
        this.setData({
          courseRequireHours: data.data.courseRequireHours
        })
      }).catch(e => {
        console.log(e)
      })
    ...
    filledDataFortab(data) {
        ...
        var tabShowLength=this.getTabShowLength(newNavTab);
        //console.log(tabShowLength);
